...
const VALUES = [
  {
    ...
    body: "Every experience starts with clear learning outcomes, curriculum relevance and classroom usefulness.",
    color: "bg-sky-100 text-sky-700",
  },
  {
    icon: ShieldCheck,
    title: "Trust through review",
    body: "AI assists our teams, while experienced subject experts review and refine academic resources.",
    color: "bg-emerald-100 text-emerald-700",
  },
  {
    icon: Lightbulb,
    title: "Technology with purpose",
    body: "We use technology to make learning clearer, teaching easier and progress more visible—not more complicated.",
    color: "bg-amber-100 text-amber-700",
  },
  {
    icon: HeartHandshake,
    title: "Built with schools",
    body: "Teacher and school feedback continuously shapes the platform, its resources and its workflows.",
  ...
  return (
    <MarketingShell>
      ...
      <section className="bg-slate-50 px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-sky-700">Our academic process</p>
            <h2 className="mt-3 font-display text-2xl font-bold text-slate-900 sm:text-3xl">
              How our resources are developed
            </h2>
            <p className="mt-3 text-slate-600">
              Technology helps us work faster, but academic quality remains human-led. Subject matter experts
              review, correct and refine resources before they reach learners and teachers.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        <div className="max-w-3xl">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-700">What guides us</p>
          <h2 className="mt-3 font-display text-2xl font-bold text-slate-900 sm:text-3xl">
            Learning technology people can trust
          </h2>
          <p className="mt-3 text-slate-600">
            AsliLearn.ai is designed around the real needs of learners, educators and school leadership.
          </p>
        </div>
      ...
      <section className="border-y border-slate-100 bg-slate-50 px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
