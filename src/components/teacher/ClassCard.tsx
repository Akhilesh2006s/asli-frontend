      ...
      <div className="mb-3 flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 flex items-center gap-1.5 text-xs font-medium text-gray-600">
            <BookOpen className="h-3.5 w-3.5 shrink-0 text-indigo-500" aria-hidden />
      ...
      <div className="space-y-2.5 border-t border-gray-100 pt-3 text-xs">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1.5">
          <span className="inline-flex shrink-0 items-center gap-1.5 text-gray-500">
            <CalendarRange className="h-3.5 w-3.5 text-gray-400" aria-hidden />
            Schedule
          </span>
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
          <span className="inline-flex items-center gap-1.5 text-gray-500">
            <DoorOpen className="h-3.5 w-3.5 shrink-0 text-gray-400" aria-hidden />
            Room
          </span>
