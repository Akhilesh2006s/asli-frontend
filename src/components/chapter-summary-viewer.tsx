...
function SectionCard({
  ...
  return (
    <section
      className={cn(
        'h-fit w-full overflow-hidden rounded-xl border border-blue-200/90 bg-white shadow-sm',
        className,
      )}
    >
      <div className={cn('flex items-center gap-2 border-l-[4px] px-2.5 py-1.5', stripe)}>
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-bold uppercase tracking-wider text-blue-400">{sectionNum}</p>
