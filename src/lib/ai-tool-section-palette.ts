...
export const AI_TOOL_SECTION_PALETTES: AiToolSectionPalette[] = [
  {
    ...
    cardWash: 'from-orange-100 via-orange-50/60 to-amber-100/70',
  ...
  },
  {
    ...
    cardWash: 'from-teal-100 via-teal-50/60 to-emerald-100/70',
    title: 'text-teal-800',
    subtitle: 'text-slate-900',
    label: 'text-teal-700',
  ...
  },
  {
    ...
    cardWash: 'from-pink-100 via-pink-50/60 to-rose-100/70',
    title: 'text-pink-800',
    subtitle: 'text-slate-900',
    label: 'text-pink-700',
  ...
  },
  {
    id: 'sky',
    bar: 'bg-sky-600',
    accentGradient: 'from-sky-500 to-teal-500',
    cardWash: 'from-sky-100 via-sky-50/60 to-teal-100/70',
    title: 'text-sky-900',
    subtitle: 'text-slate-900',
    label: 'text-sky-700',
    ...
    iconTile: 'bg-sky-100 text-sky-800 border-sky-200',
    chip: 'bg-sky-100 text-sky-950 border-sky-200',
    marker: 'marker:text-sky-600',
  },
  {
    id: 'blue',
    bar: 'bg-blue-600',
    accentGradient: 'from-blue-500 to-sky-600',
    cardWash: 'from-blue-100 via-blue-50/60 to-sky-100/70',
    title: 'text-blue-900',
    subtitle: 'text-slate-900',
    label: 'text-blue-700',
  ...
  },
  {
    ...
    cardWash: 'from-emerald-100 via-emerald-50/60 to-lime-100/70',
  ...
  },
  {
    ...
    cardWash: 'from-amber-100 via-amber-50/60 to-yellow-100/70',
  ...
  },
  {
    ...
    cardWash: 'from-rose-100 via-rose-50/60 to-orange-100/70',
    title: 'text-rose-900',
    subtitle: 'text-slate-900',
    label: 'text-rose-700',
  ...
  },
  {
    ...
    cardWash: 'from-cyan-100 via-cyan-50/60 to-sky-100/70',
    title: 'text-cyan-900',
    subtitle: 'text-slate-900',
    label: 'text-cyan-700',
  ...
  },
  {
    ...
    cardWash: 'from-teal-100 via-teal-50/60 to-cyan-100/70',
    title: 'text-teal-900',
    subtitle: 'text-slate-900',
    label: 'text-teal-700',
    emphasis: 'text-teal-600',
    ...
    innerBorder: 'border-teal-100',
    iconTile: 'bg-teal-100 text-teal-800 border-teal-200',
    chip: 'bg-teal-100 text-teal-950 border-teal-200',
    marker: 'marker:text-teal-600',
  },
];
